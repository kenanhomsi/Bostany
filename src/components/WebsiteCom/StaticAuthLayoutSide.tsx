...
const StaticAuthLayoutSide = () => {
    ...
    return (
        <div className={` flex  h-full  ${RegisterAs == 'Baser' ? ' bg-BaserbodyLigh' : 'bg-BostanybodyLigh'}  rounded-[32px] overflow-hidden `}>
            <div className={`py-20 pr-10 max-w-[70%] `}>
                <h2 className={` text-[28px] mb-24 font-bold  text-${RegisterAs}Primary  text-`}>ماذا يمكنك أن تزرع في 10 دقائق؟</h2>
                <div className={` ${RegisterAs == 'Baser' ? ' text-BaserOnSurfase' : 'text-BostanyOnSurface'}  flex flex-col gap-6`}>
                    <div className={``}>
