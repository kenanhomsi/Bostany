        ...
        <div className="flex flex-col gap-6  w-full">
            <div className="w-full flex flex-col gap-6">
                <input onChange={handleInputChange} value={FormData.FullName} type="text" name="FullName"
                    className={`w-full bg-BaserSurface text-dark  rounded-2xl focus:outline-2   ${RegisterAs == 'Baser' ? '  focus:outline-BaserPrimary' : 'focus:outline-BostanyPrimary'}  focus:ring-0  outline-none border-none  placeholder:text-dark  py-4 px-6`}
